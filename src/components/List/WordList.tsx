...
import WordItem from "@/pages/Dicionario/components/WordItem";

interface Props {
    searchParams: QueryParam;
    setSearchParams: React.Dispatch<React.SetStateAction<QueryParam>>;
    data: ApiResponsePage<Word> | undefined;
    isLoading: boolean;
    isError: boolean;
    error: Error | null;
    refetch: () => void;
